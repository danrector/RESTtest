...
@rem ##########################################################################
@rem
@rem  RESTtest startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and RES_TTEST_OPTS to pass JVM options to this script.
...
@rem Execute RESTtest
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RES_TTEST_OPTS%  -classpath "%CLASSPATH%" hello.Application %CMD_LINE_ARGS%
...
:fail
rem Set variable RES_TTEST_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%RES_TTEST_EXIT_CONSOLE%" exit 1
exit /b 1
